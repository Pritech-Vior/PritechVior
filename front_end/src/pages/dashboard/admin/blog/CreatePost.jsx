...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await blogManagement.createPost(submitData);
  ...
  return (
    <DashboardLayout title="Create Blog Post" userRole="admin">
      <div className="space-y-6">
        {/* Header */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-n-1">Create New Blog Post</h1>
            <p className="text-n-3 mt-1">Write and publish a new blog post</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-n-1 font-medium">Admin</p>
              ...
              {/* Help */}
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-n-1 mb-4">Need Help?</h3>
                
                <div className="space-y-3 text-sm text-n-4">
                  <p>• Use Markdown for rich text formatting</p>
                  <p>• Add images to make your post more engaging</p>
                  <p>• Choose relevant tags for better discoverability</p>
                  <p>• Write a compelling excerpt for social sharing</p>
                </div>
              </Card>
            </div>
          </div>
