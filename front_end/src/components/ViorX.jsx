...
const ViorX = () => {
  ...
  return (
    <Section className="pt-[12rem] -mt-[5.25rem]" id="viorx">
          ...
          title={
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="relative inline-block">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-color-1 to-color-2 font-bold tracking-wider text-4xl">
                  𝕏
                </span>
              </span>
            </span>
          }
          text="Next-generation academic support for students at all levels. From final year projects to research assistance and career mentorship."
        />
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-color-1/10 to-color-2/10 rounded-2xl p-8 border border-color-1/20">
            <h3 className="text-2xl font-semibold text-n-1 mb-4">
              Ready to Launch Your Academic Success?
            </h3>
            <p className="text-n-3 mb-6 max-w-2xl mx-auto">
              Join hundreds of students who have achieved academic excellence with our next-generation support services. 
