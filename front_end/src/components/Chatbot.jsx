...
import { 
  ...
  CheckCircle, Code, Database, FileText, Clock, Target, 
  Award, Book, DollarSign, Mail, Phone, MapPin, Calendar,
  Users, Star, Building, Globe, Zap
} from "lucide-react";
...
const Chatbot = () => {
  ...
  const renderMessageWithIcons = (text) => {
    ...
    return lines.map((line, index) => {
      if (line.includes('• Complete system') || line.includes('• Full-stack') || line.includes('• Database') || 
          line.includes('• Testing') || line.includes('• Documentation') || line.includes('• 6 months')) {
        return (
      ...
      if (line.includes('• Topic selection') || line.includes('• Complete development') || 
      ...
      if (line.includes('• Student Projects') || line.includes('• Custom Software') || 
          line.includes('• Tutoring') || line.includes('• Courses')) {
        return (
          <div key={index} className="flex items-center gap-2 mb-1">
      ...
      if (line.includes('• Leading IT') || line.includes('• Expert team') || 
          line.includes('• Focus on') || line.includes('• 200+') || line.includes('• Serving clients')) {
        return (
          <div key={index} className="flex items-center gap-2 mb-1">
  ...
  const predefinedResponses = {
    ...
    "services": {
      ...
      options: ["Project Development", "IT Consulting", "E-Learning", "E-Commerce", "More Info"]
    },
    ...
    "student": {
      ...
      options: ["Final Year Project", "Research Help", "Tutoring", "Templates", "Pricing"]
    },
  ...
  return (
    <>
      ...
      {!isOpen && (
        <div 
          onClick={toggleChat}
          className="fixed bottom-4 right-4 z-50 w-12 h-12 bg-gradient-to-r from-color-1 to-color-2 rounded-full shadow-lg cursor-pointer hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
          style={{
