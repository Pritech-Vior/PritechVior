...
class ProjectsService {
  ...
  async getCategories() {
    return this.getProjectCategories();
  }
  ...
  // Get requestable projects as templates
  async getRequestableProjects(params = {}) {
    const defaultParams = { is_requestable: "true", is_public: "true" };
    const mergedParams = { ...defaultParams, ...params };
    return this.getProjects(mergedParams);
  }
